  ...
  const products = [
    {
      ...
      title: 'Fresh Organic Red Bell Pepper',
      price: 3.99,
      oldPrice: 4.99,
      stock: true,
      discount: '20%',
      description:
        'Crisp and sweet red bell peppers, perfect for salads and stir-fries.',
    },
    {
      id: 2,
      img: 'https://klbtheme.com/bacola/wp-content/uploads/2021/04/product-image-42-346x310.jpg',
      title: 'Organic Broccoli Crowns',
      price: 4.85,
      oldPrice: 6.77,
      stock: true,
      discount: '29%',
      description: 'Organic broccoli crowns, ready to be steamed or roasted.',
    },
    {
      id: 3,
    ...
    },
    {
      ...
      stock: true,
      discount: '21%',
      description: 'A whole fresh coconut, ready for your favorite recipes.',
    },
    {
      id: 5,
      ...
      discount: '18%',
      description:
        'Crunchy and sweet organic carrots, great for juicing or cooking.',
    },
    {
      id: 6,
      img: 'https://klbtheme.com/bacola/wp-content/uploads/2021/04/product-image-49-346x310.jpg',
      title: 'Sweet Gala Apples',
      price: 1.19,
      oldPrice: 1.49,
      stock: true,
      discount: '20%',
      description: 'Sweet, crisp Gala apples, perfect for lunches and snacks.',
    },
    {
      id: 7,
      ...
      stock: true,
      discount: '20%',
      description: 'Cool and crisp organic cucumbers, great for snacking.',
    },
    {
      id: 8,
      img: 'https://klbtheme.com/bacola/wp-content/uploads/2021/04/product-image-45-346x310.jpg',
      title: 'Sweet Potatoes (Bulk)',
      price: 3.49,
      oldPrice: 4.19,
      stock: true,
      discount: '17%',
      description: 'Nutrient-rich sweet potatoes, versatile for many dishes.',
    },
  ]
